...
class PageButton(discord.ui.View):
    ...
    async def page_4(self, interaction: discord.Interaction):
        embed = discord.Embed(colour=discord.Colour.blue(), description=self.texts[3])
...
class DeleteConfirm(discord.ui.View):
    ...
    async def page_yes(self, interaction: discord.Interaction):
        ...
        await interaction.response.send_message(
            self.lang["char_delete"], ephemeral=True
        )

    async def page_no(self, interaction: discord.Interaction):
        await interaction.response.send_message(
            self.lang["char_delete_cancel"], ephemeral=True
        )
...
class Form(discord.ui.Modal):
    ...
    avatar = discord.ui.TextInput(
        label="temp", style=discord.TextStyle.short, required=False
    )
...
class Slash(commands.Cog):
    ...
    @app_commands.command(
        name="twitter", description="Log in to write as your character"
    )
    ...
    async def twitter_post(
        self, interaction: discord.Interaction, choices: str, *, text: str
    ):
